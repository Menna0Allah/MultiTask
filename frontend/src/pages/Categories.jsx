      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700">
            ...
            <div className="text-gray-600 dark:text-gray-400">Available Tasks</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700">
            <div className="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-2">
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-primary-600 to-primary-800 dark:from-primary-700 dark:to-primary-900 rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <Link
            to="/tasks/create"
            className="inline-block px-8 py-3 bg-white text-primary-600 dark:bg-gray-100 dark:text-primary-700 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-gray-200 transition-colors"
          >
            Post a Task
          </Link>
        </div>
